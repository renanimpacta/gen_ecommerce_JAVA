	...
	public static void main(String[] args) {
		...
		while (opcaoPgto == 'x') {
			...
			for (int y = 0; y < QUANTIDADE; y++) {
				...
				// _____________________________FELIPE_______________________________________
				...
				if (continuarCompra == 's' || continuarCompra == 'S') {
					...
					// ________________________________________________________________________________________________________Cássia______________________________________}
					if (opcaoPgto == '1') {
